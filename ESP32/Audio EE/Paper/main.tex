...
\begin{itemize}
   \item Chất lượng tín hiệu âm thanh: so sánh đầu vào và đầu ra sau khi giải mã bằng tai người và phân tích phổ.
   \item Độ méo tổng hợp (THD) và tỉ số tín hiệu trên nhiễu (SNR): xác định chất lượng của luồng âm thanh sau khi truyền qua RS485.
\end{itemize}
